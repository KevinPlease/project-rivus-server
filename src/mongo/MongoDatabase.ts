import { Admin, Db, Document, MongoClient, MongoClientOptions } from "mongodb";
...
class MongoDb {
	...
	public addUser(username: string, password: string, roles: Dictionary[]) : Promise<Document> | undefined {
