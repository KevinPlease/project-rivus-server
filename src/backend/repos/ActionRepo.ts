...
class ActionRepo extends BaseRepo<ActionData> {
	...
	public async addDefaultData(say: MessengerFunction): Promise<OperationStatus> {
		...
		const data: ActionData[] = [
			...
			{ name: "Get Customer Document", description: "" },
			...
			{ name: "Add Property Documents", description: "" },
			{ name: "Get Property Document", description: "" },
			...
			{ name: "Add Unit Documents", description: "" },
			{ name: "Get Unit Document", description: "" },
